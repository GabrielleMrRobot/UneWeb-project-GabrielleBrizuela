<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <form method="POST" action="<?php echo base_url(); ?>/cajas/cerrar"
                        autocomplete="off">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    ...
                                    value="<?php echo $caja['numero_caja']; ?>"
                                    autofocus required/>
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <input class="form-control" id="nombre" name="nombre" type="text"
                                     value="<?php $session->nombre; ?>" required/>
                        ...
                        <div class="row">
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <input class="form-control" id="no_ventas" name="no_ventas" type="text"
                                    value ="" required/>
                        </div>
                        </div>
                        </div>
