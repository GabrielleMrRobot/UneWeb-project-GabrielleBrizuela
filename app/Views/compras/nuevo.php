                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-12 col-sm-4">
                                   ...
                                   placeholder="Escribe el codigo y presiona enter" onkeyup="buscarProducto(event, this, this.value)" autofocus/>
                         ...
                         <div class="row">
                              <div class="col-12 col-sm-6 offset-md-6">
                               ...
                               <input type="text" id="total" name="total" size="7" readonly="true" value="0.00" style="font-weight: bold; font-size: 30px; 
                               text-align: center;" />
                ...
                success: function(resultado) {
                    if (resultado == 0) {
                        ...
                        if (resultado.existe) {
                            ...
                            actualizarSubtotal(); // Llama a la función para actualizar el subtotal
                            $("#cantidad").on('input', actualizarSubtotal); // Escucha cambios en la cantidad para actualizar el subtotal
                            $("#cantidad").focus();
                        } else {
                            $("#id_producto").val('');
                            $("#nombre").val('');
...
function actualizarSubtotal() {
    ...
    $("#subtotal").val(subtotal.toFixed(2)); // Asegura que el subtotal tenga 2 decimales
}
