<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="ui-widget">
                            ...
                            name="cliente" placeholder="Escribe el nombre del cliente"
                            value="Público en general" onkeyup="agregaProducto()"
            ...
            <div class= row >
                <table id="tablaProductos" class="table table-hover table-striped table-sm table-responsive tabla Productos" width="100%">
            ...
            select: function (event, ui){
                ...
                setTimeout(
                    function(){
                        ...
                        e.which = 13; // ASCII value for enter key
